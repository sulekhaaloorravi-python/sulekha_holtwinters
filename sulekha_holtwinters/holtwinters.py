class holtwinters:
    ...
    '''
    def extract_actuals(self, sparkDF):
        '''
        author_contact: sulekha.aloorravi@gmail.com
    ...
    def initiate_trend_factor(self,sparkDF,L):
        '''
        author_contact: sulekha.aloorravi@gmail.com
        ...
        '''
        observed = self.extract_actuals(sparkDF)
        b_numerator = 0.0
        for i in range(L):
    ...
    def initiate_seasonal_indices_multiplicative(self,sparkDF,L):
        '''
        author_contact: sulekha.aloorravi@gmail.com
    ...
    def initiate_seasonal_indices_additive(self,sparkDF,L):
        '''
        author_contact: sulekha.aloorravi@gmail.com
    ...
    def holtwinters_multiplicative(self,sparkDF,alpha,beta,gamma,L,n_predictions):
        '''
        author_contact: sulekha.aloorravi@gmail.com
        ...
        observed = self.extract_actuals(sparkDF)
        period = int(len(observed)/L)
        SeasonalIndices,Avgs,Subset = self.initiate_seasonal_indices_multiplicative(sparkDF,L)
        trendfactor = self.initiate_trend_factor(sparkDF,L)
    ...
    def holtwinters_additive(self, sparkDF,alpha,beta,gamma,L,n_predictions):
        '''
        author_contact: sulekha.aloorravi@gmail.com
        ...
        observed = self.extract_actuals(sparkDF)
        period = int(len(observed)/L)
        SeasonalIndices,Avgs,Subset = self.initiate_seasonal_indices_additive(sparkDF,L)
        trendfactor = self.initiate_trend_factor(sparkDF,L)
        Seasonality = SeasonalIndices
        Predictions = []
        p = len(observed)
    ...
    def BestFit_Multiplicative(self,sparkDF, interval, denominator, L, n_predictions):
        '''
        author_contact: sulekha.aloorravi@gmail.com
        ...
        for i in [float(j) / denominator for j in range(0, denominator, interval)]:
            for a in [float(b) / denominator for b in range(0, denominator, interval)]:
                for l in [float(m) / denominator for m in range(0, denominator, interval)]:
                    Observed, Predictions, Level, Trend, Seasonality = self.holtwinters_multiplicative(sparkDF,i,a,l,L,n_predictions)
                    Acc.append(self.Accuracy(Observed, Predictions))
                    alpha.append(i)
                    beta.append(a)
                    gamma.append(l)
    ...
    def BestFit_Additive(self,sparkDF, interval, denominator, L, n_predictions):
        '''
        author_contact: sulekha.aloorravi@gmail.com
        ...
        for i in [float(j) / denominator for j in range(0, denominator, interval)]:
            for a in [float(b) / denominator for b in range(0, denominator, interval)]:
                for l in [float(m) / denominator for m in range(0, denominator, interval)]:
                    Observed, Predictions, Level, Trend, Seasonality = self.holtwinters_additive(sparkDF,i,a,l,L,n_predictions)
                    Acc.append(self.Accuracy(Observed, Predictions))
                    alpha.append(i)
                    beta.append(a)
                    gamma.append(l)
